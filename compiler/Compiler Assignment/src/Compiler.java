...
//        out.println("    ldc \" This assignment is made by Jeroen Koster and Nicky ter Maat\"");
        out.println();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (args.length == 0) {
                ...
                //System.err.println("Usage: Compiler <file to compile>");
                //System.err.println("Supply a command line argument via console or run configuration");
                compiler.compileString(sourceCode, "HelloWorld.j", "HelloWorld.class");
            } else {
